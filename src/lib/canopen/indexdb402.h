...
public:
    enum OdObject
    {
        ...
        OD_MS_BRAKE_MODE,
        OD_MS_BRAKE_EXITATION_TIME,
        OD_MS_BRAKE_EXITATION_DUTY,
        OD_MS_BRAKE_ACTIVATED_DUTY,
        OD_MS_BRAKE_RELEASE_DELAY,
        OD_MS_BRAKE_RELEASE_TO_OE,
        OD_MS_BRAKE_CLOSING_DELAY,
        OD_MS_BRAKE_CLOSING_TO_IDLE,
