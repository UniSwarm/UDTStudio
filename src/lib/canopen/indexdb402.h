...
public:
    enum OdObject
    {
        ...
        OD_MS_SPEED_INPUT,
        OD_MS_SPEED_ERROR,
        OD_MS_SPEED_INTEGRATOR,
        OD_MS_SPEED_OUTPUT,
        OD_MS_SPEED_P,
        OD_MS_SPEED_I,
        OD_MS_SPEED_D,
        OD_MS_SPEED_PERIOD_US,
        OD_MS_SPEED_SENSOR_SELECT,
        OD_MS_SPEED_NUMERATOR,
        OD_MS_SPEED_DENOMINATOR,
        OD_MS_SPEED_OFFSET,
        OD_MS_SPEED_MIN,
        OD_MS_SPEED_MAX,
        ...
        OD_MS_POLE_PAIR,
        OD_MS_MAX_SPEED,
        OD_MS_CURRENT_CONSTANT,
        OD_MS_LIMIT_MIN,
        OD_MS_LIMIT_MAX,
        OD_MS_HOME,
        OD_MS_POLARITY,
        OD_MS_BRAKE_MAINTAIN,
        OD_MS_BRAKE_PEAK,
