...
public:
    enum OdObject
    {
        ...
        OD_MS_VELOCITY_INPUT,
        OD_MS_VELOCITY_ERROR,
        OD_MS_VELOCITY_INTEGRATOR,
        OD_MS_VELOCITY_OUTPUT,
        OD_MS_VELOCITY_P,
        OD_MS_VELOCITY_I,
        OD_MS_VELOCITY_D,
        OD_MS_VELOCITY_PERIOD_US,
        OD_MS_VELOCITY_SENSOR_SELECT,
        OD_MS_VELOCITY_NUMERATOR,
        OD_MS_VELOCITY_DENOMINATOR,
        OD_MS_VELOCITY_OFFSET,
        OD_MS_VELOCITY_MIN,
        OD_MS_VELOCITY_MAX,
        OD_MS_POSITION_INPUT,
        OD_MS_POSITION_ERROR,
        OD_MS_POSITION_INTEGRATOR,
        OD_MS_POSITION_OUTPUT,
        OD_MS_POSITION_P,
        OD_MS_POSITION_I,
        OD_MS_POSITION_D,
        OD_MS_POSITION_PERIOD_US,
        OD_MS_POSITION_SENSOR_SELECT,
        OD_MS_POSITION_NUMERATOR,
        OD_MS_POSITION_DENOMINATOR,
        OD_MS_POSITION_OFFSET,
        OD_MS_POSITION_MIN,
        OD_MS_POSITION_MAX,
        OD_MS_TORQUE_INPUT,
        OD_MS_TORQUE_ERROR,
        OD_MS_TORQUE_INTEGRATOR,
        OD_MS_TORQUE_OUTPUT,
        OD_MS_TORQUE_P,
        OD_MS_TORQUE_I,
        OD_MS_TORQUE_D,
        OD_MS_TORQUE_PERIOD_US,
        OD_MS_TORQUE_SENSOR_SELECT,
        OD_MS_TORQUE_NUMERATOR,
        OD_MS_TORQUE_DENOMINATOR,
        OD_MS_TORQUE_OFFSET,
        OD_MS_TORQUE_MIN,
        OD_MS_TORQUE_MAX,
