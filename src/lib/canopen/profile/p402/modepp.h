...
public:
    ...
    bool isNewSetPoint() const;  // bit 4 of controlWord front upright

    void setChangeSetImmediately(bool ok);  // bit 5 of controlWord
    bool isChangeSetImmediately() const;    // bit 5 of controlWord
    ...
    bool isChangeOnSetPoint() const;    // bit 9 of controlWord
