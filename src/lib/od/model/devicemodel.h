...
public:
    ...
    bool indexExist(const QString &name) const;
    void deleteIndex(Index *index);

    SubIndex *subIndex(uint16_t index, uint8_t subIndex) const;
    SubIndex *subIndex(const QString &index, const QString &subIndex) const;
    bool subIndexExist(uint16_t index, uint8_t subIndex) const;
    bool subIndexExist(const QString &index, const QString &subIndex) const;
